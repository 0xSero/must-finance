    ...
    try {
      ...
      setFormData({
        ...
        dimensions: {
          ...
          weight: data.dimensions?.weight?.toString() || '',
        },
        inventory: {
          quantity: data.inventory?.quantity?.toString() || '',
          lowStockThreshold: data.inventory?.lowStockThreshold?.toString() || '',
          reorderPoint: data.inventory?.reorderPoint?.toString() || '',
          reorderQuantity: data.inventory?.reorderQuantity?.toString() || '',
        },
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="isVisible">Product is visible on storefront</Label>
            </div>
          </CardContent>
        </Card>
